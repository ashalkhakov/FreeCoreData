...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    [tabBar setTarget:self action:@selector(tabBarSelectionChanged:)];
}

- (void)tabBarSelectionChanged:(id)sender {
    [tabView selectTabViewItem:[tabView.tabViewItems objectAtIndex:tabBar.selectedIndex]];
}
