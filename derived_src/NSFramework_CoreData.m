...
static NSString *allClasses[] = {@"NSManagedObjectModel", @"NSEntityDescription", @"NSPropertyDescription", @"NSAttributeDescription", @"NSDerivedAttributeDescription", @"NSRelationshipDescription", @"NSFetchedPropertyDescription", @"NSPersistentStoreRequest", @"NSSaveChangesRequest", @"NSFetchRequest", @"NSManagedObject", @"NSManagedObjectID", @"NSManagedObjectContext", @"NSManagedObjectSet", @"NSManagedObjectMutableSet", @"NSManagedObjectSetEnumerator", @"NSPersistentStoreCoordinator", @"NSPersistentStore", @"NSAtomicStore", @"NSIncrementalStore", @"NSIncrementalStoreNode", @"NSAtomicStoreCacheNode", @"NSXMLPersistentStore", @"NSSQLitePersistentStore", @"NSInMemoryPersistentStore", @"NSPropertyMapping", @"NSEntityMapping", @"NSMappingModel", @"NSEntityMigrationPolicy", @"NSMigrationManager", @"NSMergeConflict", @"NSMergePolicy", @"NSFetchedResultsController", @"NSFetchedResultsSection", NULL};
